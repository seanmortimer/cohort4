...
test('city cards render - Calgary', () => {
  ...
  render(<Card key={calg.key} city={calg} modal={mockEditClick} onDelete={mockDelClick} />);
...
test('city cards render - Quintero', () => {
  ...
  render(<Card key={quin.key} city={quin} modal={mockEditClick} onDelete={mockDelClick} />);
